    ...
    return (
        <div className="body">
            <div className="body-tag1">
                ...
                <button type="button" className="">Register Now</button>
            </div>
            <div className="body-tag2">
                ...
                <button type="button" className="">Contribute</button>
            </div>
            <div className="body-tag3">
                <div className="img">
                    <img src={dn} className="img" />
            ...
            <div className="body-tag5">
                <div className="body-tag5-card">
                    <div className="body-tag5-card-img">
                        <img src={about} className="img" alt="About" style={{ width: '100%', marginLeft: '20px' }}/>
                    </div>
                ...
                <div className="body-tag5-card">
                    ...
                    <div className="body-tag5-card-img" style={{marginRight: '60px'}}>
                        <img src={mission} className="img" alt="About" style={{width: '100%'}}/>
                    </div>
                </div>
                <div className="body-tag5-card">
                    <div className="body-tag5-card-img">
                        <img src={vision} className="img" alt="About" style={{ width: '100%' }}/>
                    </div>
                    <div className="body-tag5-card-content">
                        <h1>Our Vision</h1><br />
                        <p>
